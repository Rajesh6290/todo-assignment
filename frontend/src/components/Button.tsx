    ...
    return (
        <button
            className={`${disabled
                ...
                : `hover:ring-2 hover:ring-blue-500 hover:ring-offset-2 flex items-center justify-center text-white gap-4 px-4 py-2 font-medium tracking-wide text-base btn-class rounded-md shadow-xl bg-blue-500  ${className}`
                }`}
            onClick={() => onClick?.()}
            type={type}
            disabled={disabled}
